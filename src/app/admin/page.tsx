...
export default function AdminDashboardPage() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-heading font-bold text-foreground">Tổng quan</h1>
        <p className="text-muted-foreground mt-1">Theo dõi hoạt động kinh doanh của MIRAI</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-xl border border-border bg-background p-6 shadow-sm">
          <div className="flex items-center justify-between space-y-0 pb-2">
            <h3 className="tracking-tight text-sm font-medium">Tổng doanh thu</h3>
            <span className="p-2 bg-primary/10 rounded-full">
              <span className="font-brand text-primary font-bold text-xs">₫</span>
            </span>
          </div>
        ...
        <div className="rounded-xl border border-border bg-background p-6 shadow-sm">
          <div className="flex items-center justify-between space-y-0 pb-2">
            <h3 className="tracking-tight text-sm font-medium">Khách hàng mới</h3>
